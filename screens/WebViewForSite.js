...
import ShopTabBottomSheet from './BottomSheetViews/MessageTabBottomSheet.js'
...
class WebViewForSite extends Component {
    state = {
        activeTab: 'account',
        RBSheetView: null,
        posts: [],
    ...
    async componentDidMount() {
        this.setState({ url: this.props.route.params.url }, () => { console.log("URL -=: " + this.state.url) })
    ...
    render() {
        ...
        const myScript = `
            ...
            var divsToHideExtra = document.getElementsByClassName("hide-menu"); //divsToHide is an array
